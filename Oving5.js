...
let lagRad = (i, data) => {
  ...
  let innholdFjell = document.createTextNode(
    data.fjelltopper[i].fjell + ": " + data.fjelltopper[i].høyde + "m"
  );
  ...
  hode.setAttribute(
    "onclick",
    "visTopp(" + data.fjelltopper[i].lat + "," + data.fjelltopper[i].lng + ")"
  );
